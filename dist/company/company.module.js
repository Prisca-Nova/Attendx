...
exports.CompanyModule = CompanyModule = __decorate([
    (0, common_1.Module)({
        controllers: [company_controller_1.CompanyController, company_controller_1.EmployeeController],
        providers: [company_service_1.CompanyService, company_repository_1.CompanyRepository, employee_repository_1.EmployeeRepository],
    })
], CompanyModule);
